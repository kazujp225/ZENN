...
export default function LoginPage() {
  ...
  const handleDummyLogin = async (type: 'user' | 'pro' | 'admin') => {
    setIsLoading(true)
    setError('')
    ...
    try {
      const credentials = {
        ...
        pro: { email: 'pro@example.com', password: 'password' },
      ...
      console.error('Login error:', err)
      setError('ダミーログインに失敗しました。もう一度お試しください。')
    } finally {
      setIsLoading(false)
    }
  }
      ...
      <div className="auth-container">
        ...
        <div className="auth-card">
          ...
          <div className="auth-demo">
            ...
            <div className="auth-demo__buttons">
              <button
                ...
                disabled={isLoading}
                className="auth-demo__button auth-demo__button--user"
              >
                <span>👤</span>
                一般ユーザーとしてログイン
              </button>
              <button
                onClick={() => handleDummyLogin('pro')}
                disabled={isLoading}
                className="auth-demo__button auth-demo__button--pro"
              >
                <span>⭐</span>
                Proユーザーとしてログイン
              </button>
              <button
                ...
                disabled={isLoading}
                className="auth-demo__button auth-demo__button--admin"
              >
                <span>🔧</span>
                管理者としてログイン
              </button>
          ...
          <div className="auth-divider">
            <span className="auth-divider__text">または</span>
          </div>
